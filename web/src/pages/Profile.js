...
import { CreateFollow, Following, Followers, ProfileImage, ProfileCoverImage } from '../components/MainComponent/Users'
              ...
              <Grid item xs={12} sm={6} md={6} >
                <Paper sx={{ height: 150, mb: 1 }}>
                  <Box sx={{ display: 'flex', height: '50%' }}>
                    <ProfileImage getUser={getUser} isUserOnline={isUserOnline} userId={userId} />
                    <Typography sx={{ typography: 'h3', py: 4 }} >{getUser?.fullName}</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', height: '50%', justifyContent: 'flex-end', p: 2 }}>
